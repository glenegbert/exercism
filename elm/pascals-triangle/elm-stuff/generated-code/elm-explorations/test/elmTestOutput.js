...
var author$project$Triangle$nextValues = F2(
	function (start, list) {
		if (list.b) {
			var nextStart = list.a;
			var rest = list.b;
			return A2(
				elm$core$List$append,
				_List_fromArray(
					[start + nextStart]),
				A2(author$project$Triangle$nextValues, nextStart, rest));
		} else {
			return _List_fromArray(
				[start]);
		}
	});
var author$project$Triangle$scanL = F2(
	function (fn, b) {
		var scan = F2(
			function (a, bs) {
				if (bs.b) {
...
var author$project$Triangle$rows = function (nu) {
	return (nu <= 0) ? _List_Nil : A3(
		author$project$Triangle$scanL,
		author$project$Triangle$nextValues,
		_List_fromArray(
			[1]),
		A2(elm$core$List$repeat, nu - 1, 0));
};
		...
		[
			...
			function (_n0) {
				return A2(
					...
					_List_Nil,
					author$project$Triangle$rows(0));
			}),
			A2(
			elm_explorations$test$Test$test,
			'single row',
			function (_n1) {
				return A2(
					...
					author$project$Triangle$rows(1));
			}),
			A2(
			elm_explorations$test$Test$test,
			'two rows',
			function (_n2) {
				return A2(
					...
					author$project$Triangle$rows(2));
			}),
			A2(
			elm_explorations$test$Test$test,
			'three rows',
			function (_n3) {
				return A2(
					...
					author$project$Triangle$rows(3));
			}),
			A2(
			elm_explorations$test$Test$test,
			'four rows',
			function (_n4) {
				return A2(
					...
					author$project$Triangle$rows(4));
			}),
			A2(
			elm_explorations$test$Test$test,
			'negative rows',
...
var author$project$Test$Generated$Main423499832$main = A2(
...
_Platform_export({'Test':{'Generated':{'Main423499832':{'init':author$project$Test$Generated$Main423499832$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-17354.sock";
