...
var author$project$Gigasecond$add = function () {
	var gigasecondInMillis = A2(elm$core$Basics$pow, 10, 12);
	return A2(
		elm$core$Basics$composeR,
		elm$time$Time$posixToMillis,
		A2(
			elm$core$Basics$composeR,
			elm$core$Basics$add(gigasecondInMillis),
...
var author$project$Tests$gigasecond = function (date) {
	var _n0 = rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(date);
	if (_n0.$ === 'Ok') {
		var posix = _n0.a;
...
var author$project$Test$Generated$Main4074823559$main = A2(
...
_Platform_export({'Test':{'Generated':{'Main4074823559':{'init':author$project$Test$Generated$Main4074823559$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-92349.sock";
