...
var author$project$Strain$keep = F2(
	function (predicate, list) {
		if (list.b) {
			var x = list.a;
			var xs = list.b;
			var nextKeepers = A2(author$project$Strain$keep, predicate, xs);
			return predicate(x) ? A2(elm$core$List$cons, x, nextKeepers) : nextKeepers;
		} else {
			return _List_Nil;
		}
	});
var author$project$Strain$discard = F2(
	function (predicate, list) {
		return A2(
			author$project$Strain$keep,
			A2(elm$core$Basics$composeL, elm$core$Basics$not, predicate),
			list);
	});
var elm$core$Basics$modBy = _Basics_modBy;
var author$project$Tests$even = function (number) {
	return !A2(elm$core$Basics$modBy, 2, number);
};
...
var author$project$Tests$isFirstLetter = F2(
	function (letter, word) {
		return _Utils_eq(
			A2(elm$core$String$left, 1, word),
			letter);
	});
var author$project$Tests$lessThanTen = function (num) {
	return num < 10;
};
var author$project$Tests$odd = function (number) {
	return A2(elm$core$Basics$modBy, 2, number) === 1;
};
		...
		[
			...
			function (_n0) {
				return A2(
					...
					_List_Nil,
					A2(author$project$Strain$keep, author$project$Tests$lessThanTen, _List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'keep everything',
			function (_n1) {
				return A2(
					...
					A2(
						author$project$Strain$keep,
						author$project$Tests$lessThanTen,
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			...
			function (_n5) {
				return A2(
					...
					A2(
						author$project$Strain$keep,
						author$project$Tests$isFirstLetter('z'),
						_List_fromArray(
			...
			function (_n6) {
				return A2(
					elm_explorations$test$Expect$equal,
					_List_Nil,
					A2(author$project$Strain$discard, author$project$Tests$lessThanTen, _List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'discard everything',
...
var author$project$Test$Generated$Main345849723$main = A2(
...
_Platform_export({'Test':{'Generated':{'Main345849723':{'init':author$project$Test$Generated$Main345849723$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-43518.sock";
