		...
		_0: A2(
			...
			function (_p0) {
				...
				return A2(
					...
					_exercism$elm$RNATranscription$toRNA('C'));
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				function (_p2) {
					...
					return A2(
						...
						_exercism$elm$RNATranscription$toRNA('G'));
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					function (_p4) {
						...
						return A2(
							...
							_exercism$elm$RNATranscription$toRNA('T'));
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						function (_p6) {
							...
							return A2(
								...
								_exercism$elm$RNATranscription$toRNA('A'));
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							function (_p8) {
								...
								return A2(
									...
									_exercism$elm$RNATranscription$toRNA('ACGTGGTCTTAA'));
							}),
						_1: {ctor: '[]'}
					}
				}
...
var report = "console";
var pipeFilename = "/tmp/elm_test-73157.sock";
