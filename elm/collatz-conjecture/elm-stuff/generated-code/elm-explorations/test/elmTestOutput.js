...
var author$project$CollatzConjecture$isEven = function (num) {
	return A2(elm$core$Basics$modBy, 2, num) === 1;
};
var author$project$CollatzConjecture$nextNumber = function (num) {
	return author$project$CollatzConjecture$isEven(num) ? ((3 * num) + 1) : ((num / 2) | 0);
};
...
var author$project$Test$Generated$Main1535238589$main = A2(
...
_Platform_export({'Test':{'Generated':{'Main1535238589':{'init':author$project$Test$Generated$Main1535238589$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-22728.sock";
